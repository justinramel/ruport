...
For common tasks, Ruport provides formats for CSV, HTML, PDF, and text-
based reports.  However, the real power lies in building custom reports
and formats.  The base formatting libraries provide a number

...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "lib/ruport/report/grouping.rb",
    "lib/ruport/report/table.rb",
    "lib/ruport/data.rb",
    ...
    "util/bench/format/bench_csv.rb",
    "util/bench/format/bench_html.rb",
    "util/bench/format/bench_pdf.rb",
    "util/bench/format/bench_text.rb",
